 ...
 * Improved with Odoo-style Autocomplete + quick-create capability.
 */
export default function AddPartenaireDialog({
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.partenaireId === 0 && !isEditMode) {
      ...
      if (isEditMode && editData) {
        ...
        if (formData.versementDate && !isNaN(versementMontant) && versementMontant > 0) {
          try {
            ...
            // Versement creation is optional - continue silently
          }
        }
      }
        ...
        <DialogContent>
          ...
          {loadingPartenaires && !isEditMode ? (
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 1.5 }}>
              ...
              {/* Section: Partenaire - Odoo-style Autocomplete */}
                ...
                <Autocomplete<PartenaireOption, false, false, true>
                  ...
                  onChange={(_event: React.SyntheticEvent, newValue: string | PartenaireOption | null) => {
                    if (typeof newValue === 'string') {
                      ...
                      handleFieldChange('partenaireId', newValue?.id || 0)
                    }
                  }}
                  ...
                  renderInput={(params: AutocompleteRenderInputParams) => (
                    <TextField
                      ...
                      error={Boolean(validationErrors.partenaireId)}
                      helperText={validationErrors.partenaireId}
                      InputProps={{
                        ...params.InputProps,
                        endAdornment: (
                          <>
                ...
                <FormControlLabel
                  control={
                    <Checkbox size="small"
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange('estMaitreOeuvre', e.target.checked)}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox size="small"
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange('estMaitreOeuvreDelegue', e.target.checked)}
                    />
                  }
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr 1fr' }, gap: 2 }}>
                <TextField
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange('versementDate', e.target.value)}
                ...
                <TextField
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange('versementVolet', e.target.value)}
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 2 }}>
                <TextField
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange('imputationPoste', e.target.value)}
              ...
              <TextField
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleFieldChange('remarques', e.target.value)}
        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 1 }}>
            ...
            <Alert severity="info" sx={{ fontSize: typography.sizes.xs }}>
              Le partenaire sera cree et immediatement selectionne. Vous pourrez completer ses informations depuis la gestion des partenaires.
            </Alert>
          </Box>
        </DialogContent>
        <DialogActions sx={{ px: 3, pb: 2 }}>
          ...
          <Button
            ...
            startIcon={creatingPartenaire ? <CircularProgress size={14} /> : <PersonAddIcon />}
          >
