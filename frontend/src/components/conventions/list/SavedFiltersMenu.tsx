...
const STORAGE_KEY = 'convention-saved-filters'

interface SavedFiltersMenuProps {
  currentFilters: ConventionFilterState
  currentGroupBy: string
  onLoadFilter: (filters: ConventionFilterState, groupBy: string) => void
}
...
const SavedFiltersMenu = ({
  ...
  const countActiveInSaved = (saved: SavedFilter): number => {
      ...
      >
        ...
        <DialogContent>
          <TextField
            ...
            size="small"
            label="Nom du filtre"
            placeholder="Ex: Conventions cadre validees"
            value={filterName}
