...
const SUGGESTION_CARDS: SuggestionCard[] = [
  {
    ...
    description: 'Suivi des cadres juridiques',
    examples: [
      'Tableau des conventions validées',
      'Répartition des conventions par type',
      'Budget total des conventions par statut',
    ],
    color: '#4F46E5',
    bgColor: '#EEF2FF',
  },
  {
    ...
    title: 'Pilotage Marchés',
    description: 'Contrats et fournisseurs',
    examples: [
      'Marchés par statut',
      'Top 10 fournisseurs par montant',
      'Marchés en cours par zone géographique',
    ],
    color: '#0891B2',
    bgColor: '#ECFEFF',
  },
  {
    ...
    title: 'Suivi Projets',
    description: 'Programmes d\'investissement',
    examples: [
  ...
  },
  {
    ...
    description: 'Décomptes et paiements',
    examples: [
      'Évolution des paiements par mois',
      'Décomptes par fournisseur',
      'Montant total des décomptes par statut',
    ],
    color: '#D97706',
    bgColor: '#FFFBEB',
  },
  {
    ...
    description: 'KPIs et synthèses rapides',
    examples: [
      'Combien de marchés au total ?',
      'Montant total des conventions',
      'Bilan des paiements',
    ],
    color: '#7C3AED',
    bgColor: '#F5F3FF',
  },
  {
    ...
    description: 'Filtres et comparaisons avancées',
    examples: [
      'Marchés validés par fournisseur',
      'Conventions cadre en exécution',
      'Top 5 marchés par montant HT',
    ],
    color: '#DC2626',
    bgColor: '#FEF2F2',
  },
