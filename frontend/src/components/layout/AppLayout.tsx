...
const AppLayout = ({ children }: AppLayoutProps) => {
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: '#f5f5f5' }}>
      ...
      {/* GCP Style Sidebar - Light - Responsive */}
      <aside
        className={`fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 z-40 flex flex-col transition-transform duration-300 shadow-sm ${
      ...
      >
        ...
        <div className="p-4 border-b border-gray-200">
          <Link to="/dashboard" className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-gray-900 font-semibold text-lg">InvestPro</span>
            </div>
          </Link>
        </div>
