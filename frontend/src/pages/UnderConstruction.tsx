        ...
        <div className="max-w-2xl w-full mx-auto px-4">
          ...
          <div className="relative mb-8">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-32 h-32 bg-primary-50 rounded-full animate-pulse"></div>
            </div>
          ...
          <div className="text-center space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xl text-gray-500">En cours de développement</p>
            </div>

            <div className="bg-primary-25 rounded-xl p-8 border border-primary-100">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <button
                onClick={() => navigate(-1)}
                className="flex items-center gap-2 px-6 py-3 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-colors font-medium shadow-xs"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors font-medium shadow-xs"
              >
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-white rounded-lg p-4 border border-gray-200 text-center">
                ...
                <p className="text-sm font-medium text-gray-800">Phase 1</p>
                <p className="text-xs text-gray-500 mt-1">Fondations</p>
              </div>

              <div className="bg-white rounded-lg p-4 border-2 border-primary-500 text-center shadow-sm">
                <div className="w-12 h-12 bg-primary-50 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Construction className="w-6 h-6 text-primary-600" />
                </div>
                <p className="text-sm font-medium text-primary-800">Phase 2</p>
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 text-center opacity-60">
                ...
                <p className="text-sm font-medium text-gray-800">Phase 3</p>
